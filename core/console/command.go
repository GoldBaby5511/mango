...
// 打印日志
type CommandShowLog struct{}

func (c *CommandShowLog) name() string {
	return "showlog"
}

func (c *CommandShowLog) help() string {
	return util.StrToGBK("显示日志,关闭:showlog 0,打开:showlog 1")
}

func (c *CommandShowLog) run(args []string) string {
